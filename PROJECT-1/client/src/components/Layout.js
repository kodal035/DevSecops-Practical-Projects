  ...
  return (
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          <img src={logo} alt="DevOps-kodal035" className="logo" />
          <div>
            <h1 className="brand-title">DevOps-kodal035</h1>
            <p className="nav-subtitle">User Management</p>
          </div>
        </div>
      </header>
      <AnimatedBanner message="Welcome to DevOps-kodal035 🚀" />
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} DevOps-kodal035. All rights reserved.</p>
      </footer>
